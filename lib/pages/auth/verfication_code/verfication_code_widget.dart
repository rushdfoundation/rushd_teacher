...
import 'verfication_code_model.dart';
export 'verfication_code_model.dart';

class VerficationCodeWidget extends StatefulWidget {
  const VerficationCodeWidget({super.key});
...
class _VerficationCodeWidgetState extends State<VerficationCodeWidget> {
  late VerficationCodeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerficationCodeModel());
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'i46kk4lu' /* Please type verification code ... */,
                    ),
