...
import 'my_assessments_model.dart';
export 'my_assessments_model.dart';
...
class _MyAssessmentsWidgetState extends State<MyAssessmentsWidget> {
  late MyAssessmentsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyAssessmentsModel());
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            '0y085djq' /* Task Description here this one... */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'ycne1le1' /* Task Description here this one... */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .bodyMedium
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          '95kw39dt' /* You did not submit your homewo... */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .bodyMedium
